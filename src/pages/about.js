            ...
            <section className="about">
              <div className="container">
                ...
                <p className="aboutParagraph">
                  ...
                  was cooking fine dishes by day, and learning to code and build sites initially
                  for friends and colleagues by night. Having taken all of those learnings from
                  the mountains, I packed the snowboard up, swapped my chef knives for coding
                  tools and headed to Bournemouth where I’ve been now for a number of years.
                </p>
                <p className="aboutParagraph">
                  ...
                  has to offer, and i like to think some of their brilliance has rubbed off on me
                  too.
                </p>

                <p className="aboutParagraph">
                  My long running thought is that I have always wanted to go out on my own and
                  work with a number of SME’s to help them bring to life their digital projects,
                  websites and conversational chatbots that help them to stand out amongst the
                  bigger brands.
                </p>
                ...
                <p className="aboutParagraph">
                  ...
                  you can add functionality to an existing website yourself, get in touch! I'm be
